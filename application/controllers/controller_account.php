...
class controller_account extends Controller
{
    ...
    function action_index()
    {
        ...
        $threads = $this->model->getAllThreadsByAuthorName($_COOKIE['login']);
        $threadsOut = "";

        foreach ($threads as $thread) {
            $threadsOut .= "<a href='http://gladdos.studio/threads/get?" . $thread['1'] . "'><p>" . $thread['0'] . "</p></a>";
        }

        $this->view->generate('account_view.html', [
                "title" => "Account",
    ...
    function action_signup()
    {
        ...
        $this->view->generate('signup_view.html', [
            "title" => "Sign up",
            'activeNavBtn' => "account",
            'scripts' => ['api', 'cookies']
        ]);
    ...
    function action_signin()
    {
        ...
        $this->view->generate('signin_view.html', [
            "title" => "Sign up",
            'activeNavBtn' => "account",
            'scripts' => ['api', 'cookies']
        ]);
    ...
    function action_set_permissions()
    {
